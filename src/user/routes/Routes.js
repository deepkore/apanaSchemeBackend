...
const { getToken, COOKIE_OPTIONS, getRefreshToken,verifyUser } = require("../../authen/authenticate")
...
router.post("/signup", (req, res, next) => {
    ...
    if (!name) {
        ...
        User.register(
            new User({ username: username , email : req.body.email, firstName : name,phone : req.body.phoneNumber}),
            req.body.password,
            (err, user) => {
                console.log(err);
                console.log(user);
